...
class _CreateBusinessAccount5State extends State<CreateBusinessAccount5> {
          ...
          child: Column(
            ...
            children: [
              ...
              CustomButton(
                  buttonName: "Continue",
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) => const CreateBusinessAccount6()));
                  }),
            ],
          ),
        ),
  ...
  Widget buildStateDropdown({
    ...
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        label == "" ||  label ==null ? const SizedBox.shrink() :  Text(
          label ?? "",
          style: TextStyle(
            fontSize: 14.sp,
            fontWeight: FontWeight.w500,
        ...
        label == "" ||  label ==null ? const SizedBox.shrink() : const SizedBox(height: 8),
        Container(
